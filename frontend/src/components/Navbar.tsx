  ...
  return (
    <div className="flex items-center bg-white sticky z-10 h-[64px] px-[5vw] border-b justify-between">
      ...
      <div className='absolute right-[5vw] flex items-center gap-2 md:gap-4 md:right-[5vw]'>
        ...
        <button className='flex items-center justify-center bg-lighta text-textlightb rounded-full w-10 h-10 absolute mr-auto  right-[65px] hover:shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] md:hidden ' onClick={() => {
        ...
        <Link to={'/write'}>
          <div className=' bg-lighta text-textlightb px-2 py-2 mr-auto rounded-lg hover:shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] hidden md:block'>
